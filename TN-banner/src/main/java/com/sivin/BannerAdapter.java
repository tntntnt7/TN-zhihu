...
public abstract class BannerAdapter<T> {
    ...
    public void setImageViewSource(ImageViewWithTitle imageViewWithTitle,int position) {
        bindImage(imageViewWithTitle, mDatas.get(position));
    }
    ...
    public abstract void bindImage(ImageViewWithTitle imageViewWithTitle, T t);
